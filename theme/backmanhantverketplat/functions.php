<?php
/**
 * Bäckman Hantverket Plattsättning AB theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "Bäckman Hantverket Plattsättning AB Leads" plugin, so leads survive a theme change.
 *
 ...
 * Patterns read these through ba_lead() so one demo can be rebuilt for any firm.
 */
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'backmanhantverketplat', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'backmanhantverketplat' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'backmanhantverketplat' ) ) );

		register_block_pattern_category( 'backmanhantverketplat-sections', array( 'label' => __( 'Bäckman Hantverket Plattsättning AB sections', 'backmanhantverketplat' ) ) );
		register_block_pattern_category( 'backmanhantverketplat-pages', array( 'label' => __( 'Bäckman Hantverket Plattsättning AB page layouts', 'backmanhantverketplat' ) ) );
	}
);
