...
/**
 * Title: Not found
 * Slug: backmanhantverketplat/not-found
...
<div class="wp-block-button ba-track-cta"><a class="wp-block-button__link wp-element-button" href="<?php echo $url( '/free-quote/' ); ?>">Boka besiktning</a></div>
<!-- /wp:button -->
